export const TOTAL_METRIC_COUNT = 43;
...
export const DASHBOARD_CACHE_SCHEDULER = "Grouped cache with durable Redis storage and safe fallbacks";
...
const FAST_WARNING_PATTERNS = [/fed rate expectations/i, /meeting-probability/i, /reddit sentiment/i];
