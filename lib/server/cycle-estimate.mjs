      ...
      input: [
        {
          role: "system",
          content:
            "You are a Bitcoin market cycle analyst. You will receive all currently available dashboard indicators, plus a preferred subset of cycle-heavy indicators. Consider every available metric, but weight approximate metrics less than scraped or live metrics. Prefer stability over daily flapping, and only disagree with the deterministic estimate when the broader evidence clearly supports it. You must choose exactly one allowed phase and return valid JSON only.",
        },
        {
          role: "user",
