...
export const DASHBOARD_METRICS: DashboardMetric[] = [
  ...
  },
  {
    ...
    panelId: "cycle-regime",
    tooltip: {
      what: "Tracks how much BTC supply has stayed dormant for at least one year.",
      why: "Helps show whether older supply is tightening or re-entering circulation.",
    },
    chartType: "area",
    updateFrequency: "daily",
    bullishInterpretation: "Rising older-supply share suggests stronger holding behavior and tighter liquid supply.",
    bearishInterpretation: "Falling older-supply share suggests old coins are becoming active again.",
    learnMore:
      "HODL Waves split Bitcoin supply into age bands. This dashboard card simplifies that into the share of supply dormant for at least one year, which helps show long-term holding versus redistribution.",
    defaultVisible: true,
    mobilePriority: 2,
    valueFormat: "percent",
  },
  ...
  },
  {
    ...
    chartType: "area",
    updateFrequency: "daily",
    bullishInterpretation: "Controlled or rebuilding open interest can support healthy trend continuation.",
    bearishInterpretation: "Rapidly rising open interest can increase crowding and liquidation risk.",
    learnMore:
      "Open interest tracks the notional value of outstanding BTC futures contracts. It is useful context for leverage, crowding, and the risk of sharp long or short squeezes.",
    defaultVisible: true,
    mobilePriority: 2,
    valueFormat: "usd",
  },
  {
    ...
    chartType: "line-with-zones",
    updateFrequency: "daily",
    bullishInterpretation: "Lower NVT readings can suggest valuation is less stretched versus network usage.",
    bearishInterpretation: "High NVT readings can suggest price is outrunning transaction activity.",
    learnMore:
      "NVT Signal compares Bitcoin's valuation to on-chain transaction activity. It is often used as a network-usage valuation gauge, somewhat like a crypto version of a price-to-sales style ratio.",
    defaultVisible: true,
    mobilePriority: 2,
    valueFormat: "number",
  },
  {
    ...
    chartType: "line-with-zones",
    updateFrequency: "daily",
    bullishInterpretation: "Lower readings suggest price is closer to the lower end of the model range.",
    bearishInterpretation: "Higher readings suggest price is running hotter versus the long-term model.",
    learnMore:
      "The Bitcoin power-law model is a long-term community-followed framework rather than a fundamental truth metric. It can be useful context, but it should be treated as a model overlay, not a standalone signal.",
    defaultVisible: true,
    mobilePriority: 3,
    valueFormat: "ratio",
  },
